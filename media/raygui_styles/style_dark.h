...
static const GuiStyleProp darkStyleProps[DARK_STYLE_PROPS_COUNT] = {
    { 0, 0, static_cast<int>(0x878787ff) },    // DEFAULT_BORDER_COLOR_NORMAL
    { 0, 1, static_cast<int>(0x2c2c2cff) },    // DEFAULT_BASE_COLOR_NORMAL
    { 0, 2, static_cast<int>(0xc3c3c3ff) },    // DEFAULT_TEXT_COLOR_NORMAL
    { 0, 3, static_cast<int>(0xe1e1e1ff) },    // DEFAULT_BORDER_COLOR_FOCUSED
    { 0, 4, static_cast<int>(0x848484ff) },    // DEFAULT_BASE_COLOR_FOCUSED
    { 0, 5, static_cast<int>(0x181818ff) },    // DEFAULT_TEXT_COLOR_FOCUSED
    { 0, 6, static_cast<int>(0xFFFFFFFF) },    // DEFAULT_BORDER_COLOR_PRESSED
    { 0, 7, static_cast<int>(0xFFFFFFFF) },    // DEFAULT_BASE_COLOR_PRESSED
    { 0, 8, static_cast<int>(0xFFFFFFFF) },    // DEFAULT_TEXT_COLOR_PRESSED
    { 0, 9, static_cast<int>(0x6a6a6aff) },    // DEFAULT_BORDER_COLOR_DISABLED
    { 0, 10, static_cast<int>(0x818181ff) },    // DEFAULT_BASE_COLOR_DISABLED
    { 0, 11, static_cast<int>(0x606060ff) },    // DEFAULT_TEXT_COLOR_DISABLED
    { 0, 16, static_cast<int>(0x00000010) },    // DEFAULT_TEXT_SIZE
    { 0, 17, static_cast<int>(0x00000000) },    // DEFAULT_TEXT_SPACING
    { 0, 18, static_cast<int>(0x9d9d9dff) },    // DEFAULT_LINE_COLOR
    { 0, 19, static_cast<int>(0x3c3c3cff) },    // DEFAULT_BACKGROUND_COLOR
    { 0, 20, static_cast<int>(0x00000018) },    // DEFAULT_TEXT_LINE_SPACING
    { 1, 5, static_cast<int>(0xf7f7f7ff) },    // LABEL_TEXT_COLOR_FOCUSED
    { 1, 8, static_cast<int>(0x898989ff) },    // LABEL_TEXT_COLOR_PRESSED
    { 4, 5, static_cast<int>(0xb0b0b0ff) },    // SLIDER_TEXT_COLOR_FOCUSED
    { 5, 5, static_cast<int>(0x848484ff) },    // PROGRESSBAR_TEXT_COLOR_FOCUSED
    { 9, 5, static_cast<int>(0xf5f5f5ff) },    // TEXTBOX_TEXT_COLOR_FOCUSED
    { 10, 5, static_cast<int>(0xf6f6f6ff) },    // VALUEBOX_TEXT_COLOR_FOCUSED
};
